...
describe('GroupAndPivotDrawerComponent', () => {
  let component: GroupAndPivotDrawerComponent;
  let fixture: ComponentFixture<GroupAndPivotDrawerComponent>;
  let dataService: DataService;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [FormsModule, GroupAndPivotDrawerComponent],
      providers: [
        { provide: DataService, useValue: mockDataService }
      ]
    })
      .overrideComponent(GroupAndPivotDrawerComponent, {
        remove: { imports: [Drawer, DatePicker, ButtonDirective, ButtonIcon, ButtonLabel] },
        add: { imports: [] }
      })
      .compileComponents();

    fixture = TestBed.createComponent(GroupAndPivotDrawerComponent);
